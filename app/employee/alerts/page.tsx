...
import { Bell, Check, Filter, AlertCircle, AlertTriangle, Info, CheckCircle2, Loader2, Package, Calendar, RefreshCw, ChevronLeft } from "lucide-react"
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-orange-400">{stockCount}</p>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-amber-400">{expiryCount}</p>
